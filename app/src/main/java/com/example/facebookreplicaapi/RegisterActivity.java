...
import com.example.facebookreplicaapi.model.Register;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener{
    ...
    private void register(){
        ...
        RetrofitApi api = com.example.facebookreplicaapi.network.Retrofit.retrofitInit().create(RetrofitApi.class);
